...
class owning_bytes_ref : public vector_ref< _byte_ const > {
public:
...
class EnvInfo {
public:
    EnvInfo( BlockHeader const& _current, LastBlockHashesFace const& _lh,
        time_t _latestBlockTimestamp, u256 const& _gasUsed, u256 const& _chainID )
    ...
    // method
    EnvInfo( BlockHeader const& _current, LastBlockHashesFace const& _lh,
        time_t _latestBlockTimestamp, u256 const& _gasUsed, u256 const& _gasLimit,
        u256 const& _chainID )
        : EnvInfo( _current, _lh, _latestBlockTimestamp, _gasUsed, _chainID ) {
    ...
    time_t latestBlockTimestamp() const { return m_latestBlockTimestamp; }
...
public:
    ...
    virtual CreateResult create(
        u256, u256&, bytesConstRef, Instruction, u256, OnOpFunc const& ) = 0;
