...
static const _byte_ c_rlpMaxLengthBytes = 8;
static const _byte_ c_rlpDataImmLenStart = 0x80;
static const _byte_ c_rlpListStart = 0xc0;

static const _byte_ c_rlpDataImmLenCount =
    c_rlpListStart - c_rlpDataImmLenStart - c_rlpMaxLengthBytes;
static const _byte_ c_rlpDataIndLenZero = c_rlpDataImmLenStart + c_rlpDataImmLenCount - 1;
static const _byte_ c_rlpListImmLenCount = 256 - c_rlpListStart - c_rlpMaxLengthBytes;
static const _byte_ c_rlpListIndLenZero = c_rlpListStart + c_rlpListImmLenCount - 1;
...
public:
    ...
    RLP( _byte_ const* _b, unsigned _s, Strictness _st = VeryStrict )
    ...
    explicit RLP( std::string const& _s, Strictness _st = VeryStrict )
        : RLP( bytesConstRef( ( _byte_ const* ) _s.data(), _s.size() ), _st ) {}
...
private:
    ...
    void pushCount( size_t _count, _byte_ _offset );
