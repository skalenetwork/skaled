...
#define assertThrow( _condition, _ExceptionType, _description ) \
    ::dev::assertThrowAux< _ExceptionType >(                    \
        _condition, _description, __LINE__, __FILE__, ETH_FUNC )
...
inline void assertThrowAux( bool _condition, ::std::string const& _errorDescription, unsigned _line,
    ...
    if ( !_condition )
        ::boost::throw_exception( _ExceptionType()
                                  ...
                                  << ::boost::throw_file( _file ) << ::boost::throw_line( _line ) );
}
...
inline void assertThrowAux( void const* _pointer, ::std::string const& _errorDescription,
    ...
    assertThrowAux< _ExceptionType >(
        _pointer != nullptr, _errorDescription, _line, _file, _function );
}
