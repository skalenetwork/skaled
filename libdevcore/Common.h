...
// Binary data types.
using bytes = std::vector< _byte_ >;
using bytesRef = vector_ref< _byte_ >;
using bytesConstRef = vector_ref< _byte_ const >;
...
using bytesSec = secure_vector< _byte_ >;
...
#define DEV_INVARIANT_CHECK_HERE              \
    ::dev::InvariantChecker::checkInvariants( \
        this, BOOST_CURRENT_FUNCTION, __FILE__, __LINE__, true )
#else
