...
- deps: Third-party dependencies and external libraries.
- docs: Project documentation.
- evmc: EVMC (Ethereum Virtual Machine Connector) related code.
- evmjit: EVM JIT (Just-In-Time) compilation support.
- libbatched-io: Batched IO operations library.
- libconsensus: Consensus protocol implementation and related cryptography (e.g., BLS).
- libdevcore: Core utilities and foundational code.
- libdevcrypto: Cryptographic primitives and utilities.
- libethashseal: Ethash proof-of-work sealing logic.
- libethcore: Ethereum core logic and data structures.
- libethereum: Ethereum protocol implementation.
- libevm: Ethereum Virtual Machine implementation.
- libhistoric: Historical data and state management.
- libp2p: Peer-to-peer networking stack.
- libskale: SKALE-specific logic and extensions.
- libskale-interpreter: SKALE VM interpreter implementation.
- libskutils: SKALE-specific utility functions.
- libweb3jsonrpc: Web3 JSON-RPC server and client logic.
- skaled: Main SKALE node daemon.
- skaled_ssl_test: SSL-related tests for SKALE node.
- skale-key: Key management utilities.
- skale-vm: SKALE VM command-line tools.
- storage_benchmark: Storage benchmarking tools.
