...
struct NetworkPreferences {
    ...
    NetworkPreferences(
        std::string const& l, unsigned short lp = c_defaultListenPort, bool u = true )
...
public:
    ...
    /// Return public endpoint of upnp interface. If successful o_upnpifaddr will be a private
    /// interface address and endpoint will contain public address and port.
    static bi::tcp::endpoint traverseNAT( std::set< bi::address > const& _ifAddresses,
