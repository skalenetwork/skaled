 ...
 */
        ...
        public:
            ...
            AlethExecutive(dev::eth::HistoricState& _s, EnvInfo const& _envInfo, SealEngineFace const& _sealEngine,
            ...
            AlethExecutive(dev::eth::HistoricState& io_s, Block const& _block, unsigned _txIndex, BlockChain const& _bc, unsigned _level = 0);
             */
