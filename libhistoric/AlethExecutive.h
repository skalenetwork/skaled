 ...
 */
        ...
        public:
            ...
            AlethExecutive(dev::eth::AlethState& _s, EnvInfo const& _envInfo, SealEngineFace const& _sealEngine,
        ...
        private:
            ...
            dev::eth::AlethState& m_s;							///< The state to which this operation/transaction is applied.
