...
namespace dev::eth {
    ...
    void PrestateTracePrinter::printMinerBalanceChange(const HistoricState &_statePre,
                                                       const HistoricState &_statePost, Json::Value &preDiff,
                                                       Json::Value &postDiff) const {
        Address minerAddress = m_trace.getBlockAuthor();
