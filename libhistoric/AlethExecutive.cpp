...
namespace {
    ...
    std::string dumpStorage(AlethExtVM const &_ext) {
        ostringstream o;
        o << "    STORAGE\n";
...
AlethExecutive::AlethExecutive(
        dev::eth::HistoricState &io_s, Block const &_block, unsigned _txIndex, BlockChain const &_bc, unsigned _level)
...
bool AlethExecutive::call(Address const &_receiveAddress, Address const &_senderAddress, u256 const &_value,
...
bool AlethExecutive::call(CallParameters const &_p, u256 const &_gasPrice, Address const &_origin) {
    ...
    if (m_sealEngine.isPrecompiled(_p.codeAddress, m_envInfo.number())) {
        ...
        if (m_s.addressHasCode(_p.codeAddress)) {
            ...
            m_ext = make_shared<AlethExtVM>(m_s, m_envInfo, m_sealEngine, _p.receiveAddress,
                                            _p.senderAddress, _origin, _p.apparentValue, _gasPrice, _p.data, &c,
                                            codeHash,
...
bool AlethExecutive::create(Address const &_txSender, u256 const &_endowment, u256 const &_gasPrice, u256 const &_gas,
...
bool
AlethExecutive::createOpcode(Address const &_sender, u256 const &_endowment, u256 const &_gasPrice, u256 const &_gas,
                             bytesConstRef _init, Address const &_origin) {
...
bool AlethExecutive::createWithAddressFromNonceAndSender(Address const &_sender, u256 const &_endowment,
...
bool
AlethExecutive::create2Opcode(Address const &_sender, u256 const &_endowment, u256 const &_gasPrice, u256 const &_gas,
...
bool AlethExecutive::executeCreate(Address const &_sender, u256 const &_endowment, u256 const &_gasPrice,
    ...
    if (!_init.empty())
        m_ext = make_shared<AlethExtVM>(m_s, m_envInfo, m_sealEngine, m_newAddress, _sender, _origin,
                                        _endowment, _gasPrice, bytesConstRef(), _init, sha3(_init), _version, m_depth,
                                        true,
                                        false);
    else
...
bool AlethExecutive::go(OnOpFunc const &_onOp) {
    if (m_ext) {
