...
void AlethExecutive::initialize( Transaction const& _transaction ) {
    ...
    try {
        Ethash::verifyTransaction( m_chainParams, ImportRequirements::Everything, m_t,
            m_envInfo.latestBlockTimestamp(), m_envInfo.header(), m_envInfo.gasUsed() );
...
bool AlethExecutive::call(
    CallParameters const& _p, u256 const& _gasPrice, Address const& _origin ) {
...
bool AlethExecutive::createOpcode( Address const& _sender, u256 const& _endowment,
    u256 const& _gasPrice, u256 const& _gas, bytesConstRef _init, Address const& _origin ) {
...
bool AlethExecutive::createWithAddressFromNonceAndSender( Address const& _sender,
    u256 const& _endowment, u256 const& _gasPrice, u256 const& _gas, bytesConstRef _init,
...
bool AlethExecutive::create2Opcode( Address const& _sender, u256 const& _endowment,
    u256 const& _gasPrice, u256 const& _gas, bytesConstRef _init, Address const& _origin,
    u256 const& _salt ) {
...
bool AlethExecutive::executeCreate( Address const& _sender, u256 const& _endowment,
    u256 const& _gasPrice, u256 const& _gas, bytesConstRef _init, Address const& _origin,
    u256 const& _version ) {
