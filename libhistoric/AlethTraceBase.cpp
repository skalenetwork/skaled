...
const DebugOptions& AlethTraceBase::getOptions() const {
    return m_options;
}
...
AlethTraceBase::AlethTraceBase( Transaction& _t, Json::Value const& _options )
    ...
    static auto allocator = std::unique_ptr< v8::ArrayBuffer::Allocator >(
    ...
    // this comes from geth source

    static const string bigIntegerJS =
#include "jstracers/big_integer.js"
        ;


    v8::Local< v8::Context > context = v8::Local< v8::Context >::New( isolate, persistent_context );
    context->Enter();
    v8::Local< v8::String > initSource = v8::String::NewFromUtf8( isolate, bigIntegerJS.c_str() );
    static v8::ScriptCompiler::Source init_script_source( initSource );
    v8::Local< v8::Script > initScript =
        v8::ScriptCompiler::Compile( context, &init_script_source ).ToLocalChecked();
    v8::Local< v8::Value > initResult = initScript->Run( context ).ToLocalChecked();
    v8::String::Utf8Value utf8( isolate, initResult );
    ...
    v8::String::Utf8Value utf82( isolate, result );
    std::cout << *utf82 << std::endl;
    context->Exit();
}
...
Json::Value AlethTraceBase::getJSONResult() const {
    return m_jsonTrace;
}

string& AlethTraceBase::getTracerSrc( string& _tracerName ) {
    static const string fourByteTracerLegacyJS =
#include "jstracers/4byte_tracer_legacy.js"
        ;
    static const string bigramTracerJS =
#include "libhistoric/jstracers/bigram_tracer.js"
        ;
    static const string callTracerLegacyJS =
#include "libhistoric/jstracers/call_tracer_legacy.js"
        ;
    static const string evmdisTracerJS =
#include "libhistoric/jstracers/evmdis_tracer.js"
        ;
    static const string noopTracerLegacyJS =
#include "libhistoric/jstracers/noop_tracer_legacy.js"
        ;
    static const string opcountTracerJS =
#include "libhistoric/jstracers/opcount_tracer.js"
        ;
    static const string prestateTracerLegacyJS =
#include "libhistoric/jstracers/prestate_tracer_legacy.js"
        ;
    static const string trigramTacerJS =
#include "libhistoric/jstracers/trigram_tracer.js"
        ;
    static const string unigramTracerJS =
#include "libhistoric/jstracers/unigram_tracer.js"
        ;

    static map< string, string > jsTracerMap = { { "fourByteTracerLegacy", fourByteTracerLegacyJS },
        { "bigramTracer", bigramTracerJS }, { "callTracerLegacy", callTracerLegacyJS },
        { "evmdisTracer", evmdisTracerJS }, { "noopTracerLegacy", noopTracerLegacyJS },
        { "opcountTracer", opcountTracerJS }, { "prestateTracerLegacy", prestateTracerLegacyJS },
        { "trigramTacer", trigramTacerJS }, { "unigramTracer", unigramTracerJS } };

    return jsTracerMap[_tracerName];
}
