...
const unsigned EthashProofOfWork::defaultGlobalWorkSizeMultiplier =
    4096;  // * CL_DEFAULT_LOCAL_WORK_SIZE
const unsigned EthashProofOfWork::defaultMSPerBatch = 0;
const EthashProofOfWork::WorkPackage EthashProofOfWork::NullWorkPackage =
    EthashProofOfWork::WorkPackage();
...
EthashProofOfWork::WorkPackage& EthashProofOfWork::WorkPackage::operator=(
    EthashProofOfWork::WorkPackage const& _other ) {
    if ( this == &_other )
        return *this;
    boundary = _other.boundary;
    seedHash = _other.seedHash;
