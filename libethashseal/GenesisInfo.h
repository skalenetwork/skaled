...
enum class Network {
    ...
    MainNetwork = 1,       ///< Normal Frontier/Homestead/DAO/EIP150/EIP158/Byzantium/Constantinople
                           ///< chain.
                           // Morden = 2,			///< Normal Morden chain.
    Ropsten = 3,           ///< New Ropsten Test Network
    Skale = 4,             ///< Skale Network ///skale
    MainNetworkTest = 69,  ///< MainNetwork rules but without genesis accounts (for transaction
                           ///< tests).
    TransitionnetTest = 70,  ///< Normal Frontier/Homestead/DAO/EIP150/EIP158 chain without all the
                             ///< premine.
    FrontierTest = 71,       ///< Just test the Frontier-era characteristics "forever" (no Homestead
                             ///< portion).
    HomesteadTest = 72,      ///< Just test the Homestead-era characteristics "forever" (no Frontier
                             ///< portion).
    ...
    MainNetworkNoProofTest = 80,  ///< MainNetwork rules without genesis accounts + NoProof seal
                                  ///< engine
