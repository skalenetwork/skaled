...
| --------------- | ----------------------------------------------------------------------------------------------------------------- |
| LondonForkPatch | Enables London EVM rules, including base-fee handling, EIP-3529 refund changes, and EIP-3541 bytecode validation. |
| ParisForkPatch  | Enables Paris block rules, including EIP-3675 and EIP-4399 PREVRANDAO handling.                                   |
