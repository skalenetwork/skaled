...
A wrapper function is available via `skale-supervisor` that provides the same information as `skale_getDBUsage`, but **includes per-database and per-shard details** for rotated databases.

### Usage

```bash
python main.py tools get-skaled-db-usage [HTTP_ENDPOINT] --network testnet --schain-type medium
```

More usage information is available [here](http://54.200.198.95:10323).
...
```json
{
  "consensusDbUsage": {
    "block_proposal.db": {
      "TotalUsage": 2049,
      "TotalLimit": 594642651,
      "block_proposal.db_0": 2049,
      "block_proposal.db_1": 0,
      "block_proposal.db_2": 0,
      "block_proposal.db_3": 0,
      "block_proposal.db_4": 0
    },
    "block_sigshare.db": 295,
    "blocks.db": {
      "TotalUsage": 151795667,
      "TotalLimit": 5946426514,
      "blocks.db_0": 151795667,
      "blocks.db_1": 0,
      "blocks.db_2": 0,
      "blocks.db_3": 0,
      "blocks.db_4": 0
    },
    "consensus_state.db": 295,
    "da_proof.db": 295,
    "da_sigshare.db": 2486,
    "incoming_msg.db": {
      "TotalUsage": 295,
      "TotalLimit": 53517838,
      "incoming_msg.db_0": 295,
      "incoming_msg.db_1": 0,
      "incoming_msg.db_2": 0,
      "incoming_msg.db_3": 0,
      "incoming_msg.db_4": 0
    ...
    "price.db": 582820,
    "proposal_hash.db": 970,
    "proposal_vector.db": 389,
    "random.db": 295
  },
  "skaledDbUsage": {
    "state.db": {
      "TotalUsage": 239831230,
      "TotalLimit": 3995998617,
      "contractStorageUsed": 87872
    },
    "blocks_and_extras.db": {
      "TotalUsage": 233545410,
      "TotalLimit": 1331999539,
      "pieceUsageBytes": 114133921,
      "blocks_and_extras.db_0": 233545410,
      "blocks_and_extras.db_1": 0,
      "blocks_and_extras.db_2": 0,
      "blocks_and_extras.db_3": 0,
      "blocks_and_extras.db_4": 0
    }
  }
}
```
