...
Ethereum has a contract code size limit of 24576 bytes. SKALE chains are configurable with code size limits of 16, 32, 64, 128, 256. 512. 1024 k-bytes and unlimited.
