...
To work with other blockchains like Ethereum Testnets or Mainnet, you can use xref:ima::index.adoc[a bridge called Interchain Messaging Agent (IMA)]. IMA allows the transfer of ETH, ERC20, ERC721, ERC1155, and other arbitrary messages between Ethereum and your SKALE Chain.
...
SKALE chains have a default code size limit of 24576 bytes, and are configurable at chain deployment to code size limits of 16, 32, 64, 128, 256, 512, 1024 kB and unlimited. (Ethereum has a contract code size limit of 24576 bytes.)
