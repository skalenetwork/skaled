    ...
    SnapshotHashAgent(
        ...
        if ( common_public_key == "" ) {
            this->common_public_key_.X.c0 = libff::alt_bn128_Fq(
                chain_params_.nodeInfo.commonBLSPublicKeys[0].c_str() );
            this->common_public_key_.X.c1 = libff::alt_bn128_Fq(
                chain_params_.nodeInfo.commonBLSPublicKeys[1].c_str() );
            this->common_public_key_.Y.c0 = libff::alt_bn128_Fq(
                chain_params_.nodeInfo.commonBLSPublicKeys[2].c_str() );
            this->common_public_key_.Y.c1 = libff::alt_bn128_Fq(
                chain_params_.nodeInfo.commonBLSPublicKeys[3].c_str() );
