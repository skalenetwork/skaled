...
void MDfinish( uint32_t* MDbuf, _byte_ const* strptr, uint32_t lswlen, uint32_t mswlen ) {
    ...
    for ( i = 0; i < ( lswlen & 63 ); i++ ) {
        /* _byte_ i goes into word X[i div 4] at pos.  8*(i mod 4)  */
...
h160 ripemd160( bytesConstRef _input ) {
    ...
    _byte_ const* message = _input.data();
