                ...
                if (!_generation2) {
                    ...
                    if (_owner) {
                        ...
                        if (_deploymentControl)
                            ret["accounts"]["0xD2002000000000000000000000000000000000D2"]["storage"]["0x0"] = toJS(
                                    coinbase.address());
                    } else {
    ...
    void jsonRPCPerfTest(SkaledFixture &fixture, uint64_t threadCount, Runner &_runner, double runningTimeSec = 10.0) {
        ...
        for (uint64_t i = 0; i < threadCount; ++i) {
            auto t = make_shared<thread>([&]() {
                _runner.perfRun(fixture, runningTimeSec);
            });
            threads.push_back(t);
        }
...
//    }
        ...
        std::string bytecode2 =
                "" +
...
BOOST_AUTO_TEST_CASE( oracle, *boost::unit_test::disabled() ) {
    ...
    BOOST_AUTO_TEST_CASE(EIP1898Calls) {
        ...
        std::array<Json::Value, 4> wellFormedCalls = {eip1898WellFormed, eip1898WellFormed1, eip1898WellFormed2,
                                                      eip1898WellFormed3};
        std::array<Json::Value, 6> badFormedCalls = {eip1898BadFormed, eip1898BadFormed1, eip1898BadFormed2,
                                                     eip1898BadFormed3, eip1898BadFormed4, eip1898BadFormed5};
        ...
        for (const auto &call: badFormedCalls) {
            BOOST_REQUIRE_THROW(fixture.rpcClient->eth_getStorageAtEIP1898(toJS(address), toJS(address), call),
                                jsonrpc::JsonRpcException);
        }
        ...
        for (const auto &call: badFormedCalls) {
            BOOST_REQUIRE_THROW(fixture.rpcClient->eth_getTransactionCountEIP1898(toJS(address), call),
                                jsonrpc::JsonRpcException);
        }
    }
    ...
    BOOST_AUTO_TEST_CASE(eip2930Transactions) {
        ...
        BOOST_REQUIRE(fixture.rpcClient->eth_getBalance("0xc868AF52a6549c773082A334E5AE232e0Ea3B513", "latest") ==
                      "0x16345785d8a0000");
        ...
        BOOST_REQUIRE(
                fixture.rpcClient->eth_getBalance("0x7D36aF85A184E220A656525fcBb9A63B9ab3C12b", "latest") == "0x1");
        ...
        BOOST_REQUIRE(toJS(jsToInt(block["transactions"][0]["yParity"].asString()) + 35 +
                           2 * fixture.client->chainParams().chainID) == block["transactions"][0]["v"].asString());
        ...
        BOOST_REQUIRE(fixture.client->transactionHashes(dev::h256(blockHash))[0] ==
        ...
        BOOST_REQUIRE(toJS(jsToInt(result["yParity"].asString()) + 35 + 2 * fixture.client->chainParams().chainID) ==
                      result["v"].asString());
        ...
        BOOST_REQUIRE(dev::toHexPrefixed(fixture.client->transactions(5)[0].toBytes()) ==
                      "");
        ...
        BOOST_REQUIRE(
                result["accessList"][0]["storageKeys"].isArray() && result["accessList"][0]["storageKeys"].size() == 2);
    ...
    BOOST_AUTO_TEST_CASE(eip1559Transactions) {
        ...
        BOOST_REQUIRE(fixture.rpcClient->eth_getBalance("0x5EdF1e852fdD1B0Bc47C0307EF755C76f4B9c251", "latest") ==
                      "0x16345785d8a0000");
    ...
    BOOST_AUTO_TEST_CASE(eip1559RpcMethods) {
        ...
        for (Json::Value::ArrayIndex i = 0; i < blockCnt; ++i) {
            ...
            std::string estimatedBaseFeePerGas = EIP1559TransactionsPatch::isEnabledWhen(
                    fixture.client->blockInfo(bn - i - 1).timestamp()) ? toJS(fixture.client->gasBidPrice(bn - i - 1))
                                                                       : toJS(0);
    ...
    BOOST_AUTO_TEST_CASE(etherbase_generation2) {
        ...
        BOOST_REQUIRE_EQUAL(fixture.client->balanceAt(jsToAddress(etherbase)), etherbaseBalance +
                                                                               jsToU256(t["gasUsed"].asString()) *
                                                                               jsToU256(
                                                                                       partiallyRetrieveTx["gasPrice"].asString()) -
                                                                               u256(1000000));
        BOOST_REQUIRE_EQUAL(fixture.client->balanceAt(jsToAddress("0x7aa5E36AA15E93D10F4F26357C30F052DacDde5F")),
        ...
        etherbaseBalance = fixture.client->balanceAt(jsToAddress(etherbase));
        BOOST_REQUIRE_EQUAL(jsToU256(t["gasUsed"].asString()) * jsToU256(partiallyRetrieveTx["gasPrice"].asString()),
                            etherbaseBalance);
        BOOST_REQUIRE_EQUAL(fixture.client->balanceAt(jsToAddress("0x7aa5E36AA15E93D10F4F26357C30F052DacDde5F")),
    ...
    BOOST_AUTO_TEST_CASE(PrecompiledPrintFakeEth,
        ...
        fixture.accountHolder->setAccounts({fixture.coinbase, fixture.account2, dev::KeyPair(
                dev::Secret("0x1c2cd4b70c2b8c6cd7144bbbfbd1e5c6eacb4a5efd9c86d0e29cbbec4e8483b9"))});
...
// historic node shall ignore invalid transactions in block
    BOOST_AUTO_TEST_CASE(skip_invalid_transactions) {
        ...
        cout << "Balance: "
             << fixture.rpcClient->eth_getBalance(fixture.accountHolder->allAccounts()[0].hex(), "latest") << endl;
