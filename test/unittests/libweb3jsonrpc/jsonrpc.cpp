...
//        bytes[] public decrypted;
//        bytes[] public plaintext;

//        mapping(address => uint256) private userBalances;
//        uint256 public constant PAYOUT_AMOUNT = 400000000000;

//        constructor() payable {}

//        function topUpUserBalance() external payable {
...
//        // Optional refundCell: absent
//        function submitCTX() external {
//            _submitCTXInternal(false, 0);
//        }

//        // Optional refundCell: present (derived at runtime from msg.sender)
//        function submitCTXWithRefundCell() external {
//            uint256 refundCell = uint256(keccak256(abi.encodePacked(msg.sender)));
//            _submitCTXInternal(true, refundCell);
//        }

//        function _submitCTXInternal(bool includeRefundCell, uint256 refundCell) internal {
//            uint256 randomNumber =
//                uint256(keccak256(abi.encodePacked(block.timestamp, block.number))) % 2500000 + 1000000;
...
//            bytes memory input = includeRefundCell
//                ? abi.encode(randomNumber, randomBytes, refundCell)   // new interface
//                : abi.encode(randomNumber, randomBytes);              // old interface
...
//            require(userBalances[msg.sender] >= PAYOUT_AMOUNT, "Insufficient user balance");
//            userBalances[msg.sender] -= PAYOUT_AMOUNT;

//            (bool sent, ) = payable(walletAddress).call{value: PAYOUT_AMOUNT}("");
//            require(sent, "Transfer failed");
//        }

//        function submitCTXWithInput(bytes calldata input) external {
//            (bool success, bytes memory result) = address(0x1B).staticcall(input);
//            require(success, "0x1B call failed");
...
//        function onDecrypt(bytes[] calldata decArgs, bytes[] calldata plainArgs) external {
//            delete decrypted;
//            for (uint256 i = 0; i < decArgs.length; ++i) decrypted.push(decArgs[i]);

//            delete plaintext;
//            for (uint256 i = 0; i < plainArgs.length; ++i) plaintext.push(plainArgs[i]);
//        }

//        function getDecrypted() external view returns (bytes[] memory) {
//            return decrypted;
//        }

//        function getPlaintext() external view returns (bytes[] memory) {
//            return plaintext;
//        }
//    }
    std::string bytecode = "";
    ...
    // User tops up the contract before submitCTXWithInput call.
    Json::Value topUpTx;
    topUpTx["to"] = contractAddress;
    topUpTx["from"] = toJS( senderAddress );
    topUpTx["value"] = "2000000000000";
    topUpTx["nonce"] = 1;
    topUpTx["data"] = "0xa70350dc";
    topUpTx["gas"] = "1000000";
    std::string topUpTxHash = fixture.rpcClient->eth_sendTransaction( topUpTx );
    dev::eth::mineTransaction( *( fixture.client ), 1 );
    auto topUpTxReceipt = fixture.rpcClient->eth_getTransactionReceipt( topUpTxHash );
    BOOST_REQUIRE( topUpTxReceipt["status"] == "0x1" );
    ...
    // send submitCTXWithRefundCell transaction
    txGenerate["data"] = "0xbfe2c44f";
    txGenerate["nonce"] = 5;
    std::string txGenerateHash3 = fixture.rpcClient->eth_sendTransaction( txGenerate );
    BOOST_REQUIRE_EQUAL( fixture.client->pending().size(), 1 );

    dev::eth::mineTransaction( *( fixture.client ), 1 );

    txReceipt = fixture.rpcClient->eth_getTransactionReceipt( txGenerateHash3 );
    BOOST_REQUIRE( txReceipt["status"] == "0x1" );
    BOOST_REQUIRE_EQUAL( fixture.client->debugGetTransactionQueue()->pendingBITE2Transactions()->size(), 1 );
    auto pendingCTXTransactionWithRefund = fixture.client->debugGetTransactionQueue()->pendingBITE2Transactions()->at( 0 );
    BOOST_REQUIRE( pendingCTXTransactionWithRefund.getCTXRefundStorageCell().has_value() );

    // call getMyBalance()
    Json::Value callGetMyBalance;
    callGetMyBalance["to"] = contractAddress;
    callGetMyBalance["data"] = "0x4c738909";
    callGetMyBalance["from"] = toJS( senderAddress );
    dev::u256 balanceBeforeCTX = dev::jsToInt< 32 >( fixture.rpcClient->eth_call( callGetMyBalance, "latest" ) );

    dev::eth::mineTransaction( *( fixture.client ), 1 );

    // call getMyBalance()
    dev::u256 balanceAfterCTX = dev::jsToInt< 32 >( fixture.rpcClient->eth_call( callGetMyBalance, "latest" ) );
    BOOST_REQUIRE_GT( balanceAfterCTX, balanceBeforeCTX );
}
