...
BOOST_AUTO_TEST_CASE(
    ws_serial_calls, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
...
BOOST_AUTO_TEST_CASE(
    wss_serial_calls, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
...
BOOST_AUTO_TEST_CASE(
    wss_parallel_calls, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
