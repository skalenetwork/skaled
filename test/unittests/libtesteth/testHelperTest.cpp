...
BOOST_AUTO_TEST_CASE(
    translateNetworks_gteIstanbul, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
...
BOOST_AUTO_TEST_CASE(
    translateNetworks_gtHomestead, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
...
BOOST_AUTO_TEST_CASE(
    translateNetworks_geHomestead, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
    set< string > networks = { "Frontier", ">=Homestead" };
    networks = test::translateNetworks( networks );
    for ( auto const& net : test::getNetworks() )
        BOOST_REQUIRE( networks.count( test::netIdToString( net ) ) > 0 );
...
BOOST_AUTO_TEST_CASE(
    translateNetworks_ltHomestead, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
...
BOOST_AUTO_TEST_CASE(
    translateNetworks_ltTest, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
...
BOOST_AUTO_TEST_CASE(
    translateNetworks_leHomestead, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
    set< string > networks = { "<=Homestead" };
    networks = test::translateNetworks( networks );
    BOOST_REQUIRE( networks.count( "Frontier" ) > 0 );
    BOOST_REQUIRE( networks.count( "Homestead" ) > 0 );
...
BOOST_AUTO_TEST_CASE(
    translateNetworks_leFrontier, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
...
BOOST_AUTO_TEST_CASE(
    levenshteinDistance_similar, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
...
BOOST_AUTO_TEST_CASE(
    levenshteinDistance_similar2, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
    char const* word1 = "sOmeWord";
...
BOOST_AUTO_TEST_CASE(
    levenshteinDistance_similar3, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
    char const* word1 = "sOmeWoRd";
    char const* word2 = "someword";
    size_t distance = test::levenshteinDistance( word1, strlen( word1 ), word2, strlen( word2 ) );
...
BOOST_AUTO_TEST_CASE(
    levenshteinDistance_similar4, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
    char const* word1 = "sOmeWoRd";
    char const* word2 = "soemword";
    size_t distance = test::levenshteinDistance( word1, strlen( word1 ), word2, strlen( word2 ) );
...
BOOST_AUTO_TEST_CASE(
    levenshteinDistance_AgtB, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
    char const* word1 = "someword";
...
BOOST_AUTO_TEST_CASE(
    levenshteinDistance_AgtB2, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
...
BOOST_AUTO_TEST_CASE(
    levenshteinDistance_BgtA, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
...
BOOST_AUTO_TEST_CASE(
    levenshteinDistance_BgtA2, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
...
BOOST_AUTO_TEST_CASE(
    levenshteinDistance_different, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
...
BOOST_AUTO_TEST_CASE(
    getTestSuggestions, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
    vector< string > const testList = { "test1", "test2", "BlockSuite", "BlockSuite/TestCase",
        "GeneralBlockchainTests" };
    auto list = test::testSuggestions( testList, "blocksuit" );
    BOOST_CHECK( test::inArray( list, string( "BlockSuite" ) ) );
}

BOOST_AUTO_TEST_CASE(
    getTestSuggestions2, *boost::unit_test::precondition( dev::test::run_not_express ) ) {
    vector< string > const testList = { "test1", "test2", "BlockSuite", "BlockSuite/TestCase",
