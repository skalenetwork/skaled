...
static u256 groupOrder =
    u256( "21888242871839275222246405745257275088548364400416034343698204186575808495617" );
...
BOOST_AUTO_TEST_CASE( pairing, *boost::unit_test::precondition( run_not_express ) ) {
    ...
    vk.A =
        toBigEndian(
            u256( "0x209dd15ebff5d46c4bd888e51a93cf99a7329636c63514396b4a452003a35bf7" ) ) +
        toBigEndian(
            u256( "0x04bf11ca01483bfa8b34b43561848d28905960114c8ac04049af4b6315a41678" ) ) +
        toBigEndian(
            u256( "0x2bb8324af6cfc93537a2ad1a445cfd0ca2a71acd7ac41fadbf933c2a51be344d" ) ) +
        toBigEndian( u256( "0x120a2a4cf30c1bf9845f20c6fe39e07ea2cce61f0c9bb048165fe5e4de877550" ) );
    vk.B =
        toBigEndian(
            u256( "0x2eca0c7238bf16e83e7a1e6c5d49540685ff51380f309842a98561558019fc02" ) ) +
        toBigEndian( u256( "0x03d3260361bb8451de5ff5ecd17f010ff22f5c31cdf184e9020b06fa5997db84" ) );
    vk.C =
        toBigEndian(
            u256( "0x2e89718ad33c8bed92e210e81d1853435399a271913a6520736a4729cf0d51eb" ) ) +
        toBigEndian(
            u256( "0x01a9e2ffa2e92599b68e44de5bcf354fa2642bd4f26b259daa6f7ce3ed57aeb3" ) ) +
        toBigEndian(
            u256( "0x14a9a87b789a58af499b314e13c3d65bede56c07ea2d418d6874857b70763713" ) ) +
        toBigEndian( u256( "0x178fb49a2d6cd347dc58973ff49613a20757d0fcc22079f9abd10c3baee24590" ) );
    vk.gamma =
        toBigEndian(
            u256( "0x25f83c8b6ab9de74e7da488ef02645c5a16a6652c3c71a15dc37fe3a5dcb7cb1" ) ) +
        toBigEndian(
            u256( "0x22acdedd6308e3bb230d226d16a105295f523a8a02bfc5e8bd2da135ac4c245d" ) ) +
        toBigEndian(
            u256( "0x065bbad92e7c4e31bf3757f1fe7362a63fbfee50e7dc68da116e67d600d9bf68" ) ) +
        toBigEndian( u256( "0x06d302580dc0661002994e7cd3a7f224e7ddc27802777486bf80f40e4ca3cfdb" ) );
    vk.gammaBeta1 =
        toBigEndian(
            u256( "0x15794ab061441e51d01e94640b7e3084a07e02c78cf3103c542bc5b298669f21" ) ) +
        toBigEndian( u256( "0x14db745c6780e9df549864cec19c2daf4531f6ec0c89cc1c7436cc4d8d300c6d" ) );
    vk.gammaBeta2 =
        toBigEndian(
            u256( "0x1f39e4e4afc4bc74790a4a028aff2c3d2538731fb755edefd8cb48d6ea589b5e" ) ) +
        toBigEndian(
            u256( "0x283f150794b6736f670d6a1033f9b46c6f5204f50813eb85c8dc4b59db1c5d39" ) ) +
        toBigEndian(
            u256( "0x140d97ee4d2b36d99bc49974d18ecca3e7ad51011956051b464d9e27d46cc25e" ) ) +
        toBigEndian( u256( "0x0764bb98575bd466d32db7b15f582b2d5c452b36aa394b789366e5e3ca5aabd4" ) );
    vk.Z =
        toBigEndian(
            u256( "0x217cee0a9ad79a4493b5253e2e4e3a39fc2df38419f230d341f60cb064a0ac29" ) ) +
        toBigEndian(
            u256( "0x0a3d76f140db8418ba512272381446eb73958670f00cf46f1d9e64cba057b53c" ) ) +
        toBigEndian(
            u256( "0x26f64a8ec70387a13e41430ed3ee4a7db2059cc5fc13c067194bcc0cb49a9855" ) ) +
        toBigEndian( u256( "0x2fd72bd9edb657346127da132e5b82ab908f5816c826acb499e22f2412d1a2d7" ) );
    vk.IC.push_back( toBigEndian( u256(
    ...
    vector< u256 > input;
    input.push_back(
        u256( "13986731495506593864492662381614386532349950841221768152838255933892789078521" ) );
    input.push_back(
        u256( "622860516154313070522697309645122400675542217310916019527100517240519630053" ) );
    input.push_back(
        u256( "11094488463398718754251685950409355128550342438297986977413505294941943071569" ) );
    input.push_back(
        u256( "6627643779954497813586310325594578844876646808666478625705401786271515864467" ) );
    input.push_back(
        u256( "2957286918163151606545409668133310005545945782087581890025685458369200827463" ) );
    input.push_back(
        u256( "1384290496819542862903939282897996566903332587607290986044945365745128311081" ) );
    input.push_back(
        u256( "5613571677741714971687805233468747950848449704454346829971683826953541367271" ) );
    input.push_back(
        u256( "9643208548031422463313148630985736896287522941726746581856185889848792022807" ) );
    ...
    BOOST_REQUIRE( ret.first );
    BOOST_REQUIRE( ret.second == toBigEndian( u256( 1 ) ) );
    ret = pairingprod_helper( proof.K + vk.gamma +
                              negateG1( addG1( vkx, addG1( proof.A, proof.C ) ) ) + vk.gammaBeta2 +
                              negateG1( vk.gammaBeta1 ) + proof.B );
    BOOST_REQUIRE( ret.first );
    BOOST_REQUIRE( ret.second == toBigEndian( u256( 1 ) ) );
    ret = pairingprod_helper(
        addG1( vkx, proof.A ) + proof.B + negateG1( proof.H ) + vk.Z + negateG1( proof.C ) + P2 );
    BOOST_REQUIRE( ret.first );
    BOOST_REQUIRE( ret.second == toBigEndian( u256( 1 ) ) );
...
BOOST_AUTO_TEST_CASE( generateRandomPoints, *boost::unit_test::precondition( run_not_express ) ) {
    ...
    std::tie( success, output ) = alt_bn128_G1_mul( ref( input ) );
    BOOST_REQUIRE( success );
    BOOST_CHECK_EQUAL( toHex( output ),
    ...
    BOOST_REQUIRE( success );
    BOOST_CHECK_EQUAL( toHex( output ),
        "07c2b7f58a84bd6145f00c9c2bc0bb1a187f20ff2c92963a88019e7c6a014eed06614e20c147e940f2d70da3f7"
        "4c9a17df361706a4485c742bd6788478fa17d7" );
    bytes b = std::move( output );

    input = a + b;
    BOOST_CHECK_EQUAL( toHex( input ),
        "18b18acfb4c2c30276db5411368e7185b311dd124691610c5d3b74034e093dc9063c909c4720840cb5134cb9f5"
        "9fa749755796819658d32efc0d288198f3726607c2b7f58a84bd6145f00c9c2bc0bb1a187f20ff2c92963a8801"
        "9e7c6a014eed06614e20c147e940f2d70da3f74c9a17df361706a4485c742bd6788478fa17d7" );
...
BOOST_AUTO_TEST_CASE( benchECADD, *boost::unit_test::precondition( run_not_express ) ) {
    ...
    BOOST_CHECK_EQUAL( toHex( v ),
        "07ac1ef4e12f6bc2a1c780aa31e3cbea913a3e24d92f0a936817fe825319ae2a2541c130d13107fd99e2aca8bb"
        "647f0a098449c9a45ef44be0c9dc5ad298f355" );
    BOOST_CHECK_EQUAL( toHex( w ),
        "002d85fbe013fa580e85705ec058f4868db26e740e5262ac4bb7e2a579d61f381d56f11fb11cc3f6df6fe8f7dc"
...
BOOST_AUTO_TEST_CASE( benchECMULRand, *boost::unit_test::precondition( run_not_express ) ) {
    ...
    BOOST_CHECK_EQUAL( toHex( v ),
        "0e9138e9515b63654de63453e2473362f9e1ef3b457f1b671dcb0513fc43c3b51dd4b43630c4b2835266c0c5c3"
...
BOOST_AUTO_TEST_CASE( benchECMULWorstCase1, *boost::unit_test::precondition( run_not_express ) ) {
    ...
    BOOST_CHECK_EQUAL( toHex( v ),
        "1701eb8c738f0f3a531d9b5468cbb7a9bb298c93d7c462bc5b06c69e78ee054927e136cbd59c7c29f6333105ce"
...
BOOST_AUTO_TEST_CASE( benchECMULWorstCase2, *boost::unit_test::precondition( run_not_express ) ) {
    ...
    BOOST_CHECK_EQUAL( toHex( v ),
        "002dd4014cc80a8b493f703a8cb6940b54795923e146ef15d264a7627c790d56303c653f248c7612e90683508d"
...
BOOST_AUTO_TEST_CASE( ECMULuseCaseFromRopsten, *boost::unit_test::precondition( run_not_express ) ) {
    ...
    std::tie( success, output ) = alt_bn128_G1_mul( ref( input ) );
    BOOST_REQUIRE( success );
    BOOST_REQUIRE_EQUAL( toHex( output ),
        "0868bea7e99c34c3a289a668bc94374858954890f16469dae702bb55ed06cff2"
