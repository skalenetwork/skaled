                                                  ...
                                                  R"E(
{
   ...
   "skaleConfig": {
    ...
    "accounts": {
        ...
        "0xD2001300000000000000000000000000000000D4": { "balance": "0", "nonce": "0", "storage": {}, "code":""},
...
BOOST_AUTO_TEST_CASE( nonLinearConsumption ) {
    ...
    //    contract Test {
    //
    //        function test(uint maxGasUsed) public {
    //            uint initialGas = gasleft();
    ...
    // data to call method test(80000)
    bytes data =
            jsToBytes( "0x29e99f070000000000000000000000000000000000000000000000000000000000013880" );
    ...
    BOOST_CHECK_EQUAL( estimate, u256( 23625 ) );
