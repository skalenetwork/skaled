 ...
 * Loads the blockchain from json, creates temporary directory to store it, removes the directory on
 * dealloc
 */
...
public:
    ...
    State const& state() const { return m_block.state(); }  // TODO remove?
