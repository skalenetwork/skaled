...
json_spirit::mObject fillBCTest( json_spirit::mObject const& _input ) {
    ...
    output["postState"] = fillJsonWithState(testChain.topBlock().state().createStateCopyWithReadLock() );
    ...
    output["pre"] = fillJsonWithState(prestate.createStateCopyWithReadLock() );
