...
namespace dev {
template < class S >
class IpcServerBase : public jsonrpc::AbstractServerConnector {
public:
    IpcServerBase( std::string const& _path );
    virtual ~IpcServerBase() {}
...
protected:
    ...
    virtual bool OnRequest( const std::string& request, void* addInfo );  // l_sergiy: migration to
                                                                          // new json-rpc-cpp
