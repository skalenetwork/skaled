...
void SkaleStats::initStatsCounters() {
    ...
    std::vector< std::string > ethJsonRpcMethods = { // Web3 Namespace
        ...
        // Eth Namespace
        "eth_protocolVersion", "eth_syncing", "eth_gasPrice", "eth_blockNumber",
        ...
        "eth_getUncleCountByBlockNumber", "eth_getTransactionByHash",
        "eth_getTransactionByBlockHashAndIndex", "eth_getTransactionByBlockNumberAndIndex",
        "eth_getTransactionReceipt", "eth_getTransactionCount", "eth_sendRawTransaction",
        "eth_call", "eth_estimateGas", "eth_getCode", "eth_getBalance", "eth_getStorageAt",
        "eth_newFilter", "eth_newBlockFilter", "eth_newPendingTransactionFilter",
        "eth_uninstallFilter", "eth_getFilterChanges", "eth_getFilterLogs", "eth_getLogs",
        "eth_accounts", "eth_sign", "eth_signTransaction", "eth_sendTransaction", "eth_coinbase",
        "debug_traceTransaction", "debug_traceBlock", "debug_getRawTransaction"
    };
