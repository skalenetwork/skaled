...
public:
    PersonalFace() {
        this->bindAndAddMethod(
            jsonrpc::Procedure( "personal_newAccount", jsonrpc::PARAMS_BY_POSITION,
                jsonrpc::JSON_STRING, "param1", jsonrpc::JSON_STRING, NULL ),
            &dev::rpc::PersonalFace::personal_newAccountI );
        this->bindAndAddMethod(
            jsonrpc::Procedure( "personal_unlockAccount", jsonrpc::PARAMS_BY_POSITION,
                jsonrpc::JSON_BOOLEAN, "param1", jsonrpc::JSON_STRING, "param2",
                jsonrpc::JSON_STRING, "param3", jsonrpc::JSON_INTEGER, NULL ),
            &dev::rpc::PersonalFace::personal_unlockAccountI );
        this->bindAndAddMethod( jsonrpc::Procedure( "personal_signAndSendTransaction",
                                    jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING, "param1",
                                    jsonrpc::JSON_OBJECT, "param2", jsonrpc::JSON_STRING, NULL ),
            &dev::rpc::PersonalFace::personal_signAndSendTransactionI );
        this->bindAndAddMethod( jsonrpc::Procedure( "personal_sendTransaction",
                                    jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING, "param1",
                                    jsonrpc::JSON_OBJECT, "param2", jsonrpc::JSON_STRING, NULL ),
            &dev::rpc::PersonalFace::personal_sendTransactionI );
        this->bindAndAddMethod( jsonrpc::Procedure( "personal_listAccounts",
                                    jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_ARRAY, NULL ),
            &dev::rpc::PersonalFace::personal_listAccountsI );
    }
    ...
    inline virtual void personal_unlockAccountI(
        const Json::Value& request, Json::Value& response ) {
        response = this->personal_unlockAccount(
            request[0u].asString(), request[1u].asString(), request[2u].asInt() );
    }
    inline virtual void personal_signAndSendTransactionI(
        const Json::Value& request, Json::Value& response ) {
        response = this->personal_signAndSendTransaction( request[0u], request[1u].asString() );
    }
    inline virtual void personal_sendTransactionI(
        const Json::Value& request, Json::Value& response ) {
        response = this->personal_sendTransaction( request[0u], request[1u].asString() );
    }
    inline virtual void personal_listAccountsI(
        const Json::Value& request, Json::Value& response ) {
        ( void ) request;
    ...
    virtual bool personal_unlockAccount(
        const std::string& param1, const std::string& param2, int param3 ) = 0;
