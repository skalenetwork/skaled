...
void validateConfigJson( js::mObject const& _obj ) {
    ...
    requireJsonFields( nodeInfo, "ChainParams::loadConfig::skaleConfig::nodeInfo",
        {{"nodeName", {{js::str_type}, JsonFieldPresence::Required}},
            ...
            {"pgHttpRpcPort", {{js::int_type}, JsonFieldPresence::Optional}},
            {"pgHttpsRpcPort", {{js::int_type}, JsonFieldPresence::Optional}},
            {"pgHttpRpcPort6", {{js::int_type}, JsonFieldPresence::Optional}},
            {"pgHttpsRpcPort6", {{js::int_type}, JsonFieldPresence::Optional}},
            {"infoPgHttpRpcPort", {{js::int_type}, JsonFieldPresence::Optional}},
            {"infoPgHttpsRpcPort", {{js::int_type}, JsonFieldPresence::Optional}},
            {"infoPgHttpRpcPort6", {{js::int_type}, JsonFieldPresence::Optional}},
            {"infoPgHttpsRpcPort6", {{js::int_type}, JsonFieldPresence::Optional}},
            ...
            {"log-value-size-limit", {{js::str_type}, JsonFieldPresence::Optional}},
            {"log-json-string-limit", {{js::str_type}, JsonFieldPresence::Optional}},
            {"log-tx-params-limit", {{js::str_type}, JsonFieldPresence::Optional}},
