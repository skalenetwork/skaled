...
public:
    ...
    virtual EVMSchedule const& evmSchedule() const override final { return m_evmSchedule; }
...
private:
    EVMSchedule const& initEvmSchedule( int64_t _blockNumber, u256 const& _version ) const {
        ...
        EVMSchedule const& currentBlockSchedule =
            m_chainParams.scheduleForBlockNumber( _blockNumber );
