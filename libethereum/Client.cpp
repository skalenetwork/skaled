...
void Client::updateHashes() {
    if ( this->last_snapshot_hashes.first == this->empty_str_hash ) {
        this->last_snapshot_hashes.first = this->m_snapshotManager->getSnapshotHash( this->last_snapshoted_block );
        return;
    }
    ...
    this->last_snapshot_hashes.second = this->m_snapshotManager->getSnapshotHash( this->last_snapshoted_block );
}
