 ...
 *
 * For the account's storage, the class operates a cache. originalStorageRoot() specifies the base state of the
...
public:
    ...
    Account( u256 _nonce, u256 _balance, StorageRoot _contractRoot, h256 _codeHash, u256 const& _version,
