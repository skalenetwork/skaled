...

    {
        ...
        for (CacheID const &id : m_cacheUsage.back()) {
            ...
            switch (id.second) {
                ...
                case ExtraReceipts: {
                    WriteGuard l1(x_receipts);
                    m_receipts.erase(id.first);
                    break;
                }
                case ExtraLogBlooms: {
                    WriteGuard l1(x_logBlooms);
                    m_logBlooms.erase(id.first);
                    break;
                }
                case ExtraTransactionAddress: {
                    WriteGuard l1(x_transactionAddresses);
