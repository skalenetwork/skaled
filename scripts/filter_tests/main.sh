...
ORIGIN=`pwd`
cd ../../
git diff --name-only 6ca9f08ade13572513c088fbeb589cf7b31aabe2 develop >$ORIGIN/recent_files.txt
cd libconsensus
git diff --name-only 01712dbf49d4ee097a0a73abf19990ded5f1cfdc develop | sed 's/\(.*\)/libconsensus\/\1/g' >>$ORIGIN/recent_files.txt
cd $ORIGIN
