...
enum Strictness { CheckEverything, JustSeal, QuickNonce, IgnoreSeal, CheckNothingNew };
...
public:
    ...
    static h256 headerHashFromBlock( bytes const& _block ) {
        return headerHashFromBlock( &_block );
    }
    ...
    void setStateRoot( h256 const& _s ) { m_stateRoot = _s; }
