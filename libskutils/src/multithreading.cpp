...
namespace skutils {
	...
	namespace multithreading {
		...
		const char * mutex_action_type_2_str( e_mutex_action_type_t emat ) {
			switch( emat ) {
			case e_mutex_action_type_t::emat_init:                   return "init";
			case e_mutex_action_type_t::emat_done:                   return "done";
			case e_mutex_action_type_t::emat_validate:               return "validate";
			case e_mutex_action_type_t::emat_will_lock:              return "lock";
			case e_mutex_action_type_t::emat_did_locked_success:     return "lock-success";
			case e_mutex_action_type_t::emat_did_locked_fail:        return "lock-fail";
			case e_mutex_action_type_t::emat_will_unlock:            return "unlock";
			case e_mutex_action_type_t::emat_did_unlocked_success:   return "unlock-success";
			case e_mutex_action_type_t::emat_did_unlocked_fail:      return "unlock-fail";
			case e_mutex_action_type_t::emat_will_try_lock:          return "try-lock";
			case e_mutex_action_type_t::emat_did_try_locked_success: return "try-lock-success";
			case e_mutex_action_type_t::emat_did_try_locked_fail:    return "try-lock-fail";
			default: break;
			} /// switch( emat )
			return "emat-unknown";
		}
		...
		static void stat_mutex_action( e_mutex_action_type_t emat, pthread_lockable * pLockable ) {
			...
			try {
				fn_on_mutex_action_t & fn = on_mutex_action_handler(); // invoked on all actions(including errors)
				if( fn )
					fn( emat, pLockable );
			} catch( ... ) {
			}
		...
		static bool stat_validator(
			pthread_lockable * pLockable,
			pthread_mutex_t * pMtx,
			e_mutex_action_type_t emat,
			const char * operation_name,
			const char * recursive_suffix_str
			) {
			...
			{ // block for g_mtx
				...
				default:
					e = skutils::tools::format(
						"attempt to perform bad validation call %p/%p/%s/%s during operation %s"
						, pLockable, pMtx, name.c_str(), recursive_suffix_str, operation_name );
				break;
				} // switch( emat )
			} // block for g_mtx
		...
		basic_pthread_mutex::~basic_pthread_mutex() {
			if( initialized_ ) {
#if (defined __SKUTILS_MULTITHREADING_DEBUG__)
				stat_validator( this, &mtx_, e_mutex_action_type_t::emat_done, "skutils::multithreading::basic_pthread_mutex::dtor", helper_recursive_suffix_string() );
#endif /// (defined __SKUTILS_MULTITHREADING_DEBUG__)
				initialized_ = false;
			...
			if( is_recursive ) {
				...
				if( n != 0 ) {
					...
					stat_exception( skutils::tools::format(
						"failed create skutils::multithreading::basic_pthread_mutex %p/%p/%s/%s",
...
#if (defined __SKUTILS_MULTITHREADING_DEBUG__)
			stat_validator( this, &mtx_, e_mutex_action_type_t::emat_init, "skutils::multithreading::basic_pthread_mutex::ctor-1", helper_recursive_suffix_string() );
#endif /// (defined __SKUTILS_MULTITHREADING_DEBUG__)
			initialized_ = true;
#if (defined __SKUTILS_MULTITHREADING_DEBUG__)
			stat_validator( this, &mtx_, e_mutex_action_type_t::emat_validate, "skutils::multithreading::basic_pthread_mutex::ctor-2", helper_recursive_suffix_string() );
		...
		void basic_pthread_mutex::lock() {
			if( ! initialized_ )
				stat_exception( skutils::tools::format(
					"attempt to lock un-initialized skutils::multithreading::basic_pthread_mutex %p/%p/%s/%s",
					this, &mtx_, lockable_name(), helper_recursive_suffix_string() ) );
#if (defined __SKUTILS_MULTITHREADING_DEBUG__)
			stat_validator( this, &mtx_, e_mutex_action_type_t::emat_validate, "skutils::multithreading::basic_pthread_mutex::lock", helper_recursive_suffix_string() );
...
#endif /// (defined __SKUTILS_MULTITHREADING_DEBUG__)
				stat_exception( skutils::tools::format(
					"failed to lock skutils::multithreading::basic_pthread_mutex %p/%p/%s/%s",
					this, &mtx_, lockable_name(), helper_recursive_suffix_string() ) );
				return;
			}
#if (defined __SKUTILS_MULTITHREADING_DEBUG__)
		...
		void basic_pthread_mutex::unlock() {
			if( ! initialized_ )
				stat_exception(
					skutils::tools::format( "attempt to un-lock un-initialized skutils::multithreading::basic_pthread_mutex %p/%p/%s/%s",
					this, &mtx_, lockable_name(), helper_recursive_suffix_string() ) );
#if (defined __SKUTILS_MULTITHREADING_DEBUG__)
			stat_validator( this, &mtx_, e_mutex_action_type_t::emat_validate, "skutils::multithreading::basic_pthread_mutex::unlock", helper_recursive_suffix_string() );
...
#endif /// (defined __SKUTILS_MULTITHREADING_DEBUG__)
				stat_exception( skutils::tools::format(
					"failed to un-lock un-initialized skutils::multithreading::basic_pthread_mutex %p/%p/%s/%s",
					this, &mtx_, lockable_name(), helper_recursive_suffix_string() ) );
				return;
			}
#if (defined __SKUTILS_MULTITHREADING_DEBUG__)
		...
		bool basic_pthread_mutex::try_lock() {
			if( ! initialized_ )
				stat_exception( skutils::tools::format(
					"attempt to try-lock un-initialized skutils::multithreading::basic_pthread_mutex %p/%p/%s/%s",
					this, &mtx_, lockable_name(), helper_recursive_suffix_string() ) );
#if (defined __SKUTILS_MULTITHREADING_DEBUG__)
			stat_validator( this, &mtx_, e_mutex_action_type_t::emat_validate, "skutils::multithreading::basic_pthread_mutex::try_lock", helper_recursive_suffix_string() );
		...
		pthread_recursive_mutex::pthread_recursive_mutex( const char * name ) : basic_pthread_mutex( true, name ) { }
		pthread_recursive_mutex::pthread_recursive_mutex( const std::string & name ) : basic_pthread_mutex( true, name ) { }
