...
namespace skutils ::unddos {
    ...
    public:
        ...
        e_high_load_detection_result_t recordMethodUseAndDetectBan(uint64_t _callTimeSec, const char *_strMethod);
    ...
    public:
        ...
        e_high_load_detection_result_t register_call_from_origin(const char *_origin,
                                                                 const char *_strMethod,
                                                                 time_tick_mark _callTime = time_tick_mark(0),
