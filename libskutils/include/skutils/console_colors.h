...
namespace cc {
	...
	static inline std::string reset( const std::string & s ) { return reset() + s + reset(); }
	static inline std::ostream & reset( std::ostream & os ) { return os << reset(); }

	extern const char * normal();
	static inline std::string normal( const std::string & s ) { return normal() + s + reset(); }
	static inline std::ostream & normal( std::ostream & os ) { return os << normal(); }

	extern const char * trace();
	static inline std::string trace( const std::string & s ) { return trace() + s + reset(); }
	static inline std::ostream & trace( std::ostream & os ) { return os << trace(); }

	extern const char * debug();
	static inline std::string debug( const std::string & s ) { return debug() + s + reset(); }
	static inline std::ostream & debug( std::ostream & os ) { return os << debug(); }

	extern const char * deep_debug();
	static inline std::string deep_debug( const std::string & s ) { return deep_debug() + s + reset(); }
	static inline std::ostream & deep_debug( std::ostream & os ) { return os << deep_debug(); }

	extern const char * info();
	static inline std::string info( const std::string & s ) { return info() + s + reset(); }
	static inline std::ostream & info( std::ostream & os ) { return os << info(); }

	extern const char * deep_info();
	static inline std::string deep_info( const std::string & s ) { return deep_info() + s + reset(); }
	static inline std::ostream & deep_info( std::ostream & os ) { return os << deep_info(); }

	extern const char * note();
	static inline std::string note( const std::string & s ) { return note() + s + reset(); }
	static inline std::ostream & note( std::ostream & os ) { return os << note(); }

	extern const char * deep_note();
	static inline std::string deep_note( const std::string & s ) { return deep_note() + s + reset(); }
	static inline std::ostream & deep_note( std::ostream & os ) { return os << deep_note(); }

	extern const char * notice();
	static inline std::string notice( const std::string & s ) { return notice() + s + reset(); }
	static inline std::ostream & notice( std::ostream & os ) { return os << notice(); }

	extern const char * deep_notice();
	static inline std::string deep_notice( const std::string & s ) { return deep_notice() + s + reset(); }
	static inline std::ostream & deep_notice( std::ostream & os ) { return os << deep_notice(); }

	extern const char * attention();
	static inline std::string attention( const std::string & s ) { return attention() + s + reset(); }
	static inline std::ostream & attention( std::ostream & os ) { return os << attention(); }

	extern const char * bright();
	static inline std::string bright( const std::string & s ) { return bright() + s + reset(); }
	static inline std::ostream & bright( std::ostream & os ) { return os << bright(); }

	extern const char * sunny();
	static inline std::string sunny( const std::string & s ) { return sunny() + s + reset(); }
	static inline std::ostream & sunny( std::ostream & os ) { return os << sunny(); }

	extern const char * success();
	static inline std::string success( const std::string & s ) { return success() + s + reset(); }
	static inline std::ostream & success( std::ostream & os ) { return os << success(); }

	extern const char * found();
	static inline std::string found( const std::string & s ) { return found() + s + reset(); }
	static inline std::ostream & found( std::ostream & os ) { return os << found(); }

	extern const char * fail();
	static inline std::string fail( const std::string & s ) { return fail() + s + reset(); }
	static inline std::ostream & fail( std::ostream & os ) { return os << fail(); }

	extern const char * warn();
	static inline std::string warn( const std::string & s ) { return warn() + s + reset(); }
	static inline std::ostream & warn( std::ostream & os ) { return os << warn(); }

	extern const char * deep_warn();
	static inline std::string deep_warn( const std::string & s ) { return deep_warn() + s + reset(); }
	static inline std::ostream & deep_warn( std::ostream & os ) { return os << deep_warn(); }

	extern const char * error();
	static inline std::string error( const std::string & s ) { return error() + s + reset(); }
	static inline std::ostream & error( std::ostream & os ) { return os << error(); }

	extern const char * deep_error();
	static inline std::string deep_error( const std::string & s ) { return deep_error() + s + reset(); }
	static inline std::ostream & deep_error( std::ostream & os ) { return os << deep_error(); }

	extern const char * fatal();
	static inline std::string fatal( const std::string & s ) { return fatal() + s + reset(); }
	static inline std::ostream & fatal( std::ostream & os ) { return os << fatal(); }

	extern const char * ws_rx_inv();
	static inline std::string ws_rx_inv( const std::string & s ) { return ws_rx_inv() + s + reset(); }
	static inline std::ostream & ws_rx_inv( std::ostream & os ) { return os << ws_rx_inv(); }

	extern const char * ws_tx_inv();
	static inline std::string ws_tx_inv( const std::string & s ) { return ws_tx_inv() + s + reset(); }
	static inline std::ostream & ws_tx_inv( std::ostream & os ) { return os << ws_tx_inv(); }

	extern const char * ws_rx();
	static inline std::string ws_rx( const std::string & s ) { return ws_rx() + s + reset(); }
	static inline std::ostream & ws_rx( std::ostream & os ) { return os << ws_rx(); }

	extern const char * ws_tx();
	static inline std::string ws_tx( const std::string & s ) { return ws_tx() + s + reset(); }
	static inline std::ostream & ws_tx( std::ostream & os ) { return os << ws_tx(); }
	...
	extern bool string2time( const std::string & timeStr, std::chrono::high_resolution_clock::time_point & ptTime );
	extern bool string2duration( const std::string & s,
								 std::chrono::duration< uint64_t > & outDuration,
	...
	extern std::string time2string( std::time_t tt, uint64_t nMicroSeconds, bool isUTC = false, bool isColored = true );
	extern std::string time2string( const std::tm & aTm, uint64_t nMicroSeconds, bool isColored = true );
	extern std::string time2string( const std::chrono::high_resolution_clock::time_point & ptTime, bool isUTC = false, bool isDaysInsteadOfYMD = false, bool isColored = true );
	extern std::string now2string( bool isUTC = false, bool isDaysInsteadOfYMD = false, bool isColored = true );
	extern std::string jsNow2string( bool isUTC = true );

	inline std::string c(                          ) { return reset(); }
	inline std::string c( bool                   x ) { return flag( x ); } // true/false
	inline std::string c( const std::string &    x ) { return x; } // { return str( x ); }
	inline std::string c( const char *           x ) { return x; } // { return str( x ); }
//  inline std::string c( unsigned char          x ) { char s[2] = { char(x), '\0' }; return s; } // { return chr( x ); }
	inline std::string c( char                   x ) { char s[2] = { char(x), '\0' }; return s; } // { return chr( x ); }
//  inline std::string c( int8_t                 x ) { return num( x ); }
	inline std::string c( uint8_t                x ) { return num( x ); }
	inline std::string c( int16_t                x ) { return num( x ); }
	inline std::string c( uint16_t               x ) { return num( x ); }
	inline std::string c( int32_t                x ) { return num( x ); }
	inline std::string c( uint32_t               x ) { return num( x ); }
	inline std::string c( int64_t                x ) { return num( x ); }
	inline std::string c( uint64_t               x ) { return num( x ); }
	inline std::string c( const float &          x ) { return num( x ); }
	inline std::string c( const double &         x ) { return num( x ); }
	inline std::string c( const nlohmann::json & x, const int indent = -1 ) { return json( x, ( indent >= 0 ) ? indent : _default_json_indent_ ); }
	inline std::string c( const std::chrono::high_resolution_clock::time_point & x, bool isUTC = false, bool isDaysInsteadOfYMD = false ) { return time2string( x, isUTC, isDaysInsteadOfYMD ); }
	...
	extern std::string pe( const std::string & strPath ); // path with comment about file existance and size
	...
	inline std::string ed( bool x ) { return flag_ed( x ); } // enabled/disabled
	inline std::string yn( bool x ) { return flag_yn( x ); } // yes/no
	...
	extern std::string binary_singleline(
		const std::string & strBinaryBuffer,
		size_t cntAlign = 16,
		char chrEmptyPosition = ' ',
		const char * strSeparator = nullptr
		);
	...
	extern std::string binary_singleline_ascii(
		const void * pBinary,
		size_t cnt,
		size_t cntAlign = 16,
	...
	extern std::string binary_table(
		const void * pBinary,
		size_t cnt,
		size_t cntPerRow = 16,
	...
	extern std::string rpc_message(
		const std::string & msg,
		bool isBinaryMessage = false
		);

	enum class e_rpc_log_type_t {
		erpcltt_ws_tx,
		erpcltt_ws_rx
	}; /// enum class e_rpc_log_type_t
	...
	public:
		stream_t & os_;
		bool isAutoFlush_:1;
		streamer( stream_t & os, bool isAutoFlush = true )
			: os_( os )
