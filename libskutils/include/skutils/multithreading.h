...
namespace skutils {
	...
	namespace multithreading {
		...
		typedef std::function < bool( const std::string & s ) > fn_on_exception_t; // returns false to cancel exception throwing
		...
		typedef std::function < void ( e_mutex_action_type_t emat, pthread_lockable * pLockable ) > fn_on_mutex_action_t;
...
//		typedef std::unique_lock < mutex_type > unique_lock_type;
		...
		typedef pthread_recursive_mutex recursive_mutex_type; // typedef std::recursive_mutex recursive_mutex_type;
